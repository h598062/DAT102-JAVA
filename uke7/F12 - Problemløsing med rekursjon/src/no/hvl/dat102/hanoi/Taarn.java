...
public class Taarn {
	private final int antallRinger;
	...
	/**
	 * Utfører det første kallet til flyttRinger.<br>
	 ...
	 * flytte n-1 ringer, deretter flytte en ring og til slutt flytte den de n-1 ringene.
	 */
